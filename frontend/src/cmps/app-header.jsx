        ...
        <div className="top-bar-container">
            <header className="app-header">
                <div className="btn-box">
                    <button className="go-btn" title='Go back' onClick={() => onGo(-1)}>
                        <svg role="img" height="24" width="24" aria-hidden="true" className="btn-svg Svg-sc-ytk21e-0 kcBZLg IYDlXmBmmUKHveMzIPCF" viewBox="0 0 16 16" data-encore-id="icon"><path d="M11.03.47a.75.75 0 010 1.06L4.56 8l6.47 6.47a.75.75 0 11-1.06 1.06L2.44 8 9.97.47a.75.75 0 011.06 0z"></path>
